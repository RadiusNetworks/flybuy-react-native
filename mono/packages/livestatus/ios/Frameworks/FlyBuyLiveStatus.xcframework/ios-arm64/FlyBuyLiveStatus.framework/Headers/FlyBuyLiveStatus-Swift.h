...
#ifndef FLYBUYLIVESTATUS_SWIFT_H
#define FLYBUYLIVESTATUS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FlyBuyLiveStatus",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class FlyBuyLiveStatusOptionsBuilder;
/// Example usage:
/// \code
/// let configOptions = ConfigOptions.Builder(iconName: "ICON_NAME_HERE")
/// .build()
///
/// FlyBuyLiveStatusManager.shared.configure(withOptions: configOptions)
///
/// \endcode
SWIFT_CLASS_NAMED("LiveStatusOptions")
@interface FlyBuyLiveStatusOptions : NSObject
/// Returns a builder for <code>ConfigOptions</code>
+ (FlyBuyLiveStatusOptionsBuilder * _Nonnull)Builder SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS_NAMED("OrderAttributes")
