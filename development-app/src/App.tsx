...
import * as LiveStatus from '@radiusnetworks/react-native-flybuy-livestatus';
...
function App(): React.JSX.Element {
  ...
  React.useEffect(() => {
    ...
    LiveStatus.configureWithOptions('AppIcon', '#A162F7', '#00E5C8').catch(
      console.warn,
    );
  }, []);
  ...
  return (
    <AppStateProvider selectedToken={selectedToken}>
      <SafeAreaView style={backgroundStyle}>
        <ProjectToggle onSelectToken={setSelectedToken} />
        <ScrollView
